...
const ICON__CANCEL: String = "\uf00d"  #  | xmark
const ICON__DELETE: String = "\uf1f8"  #  | trash
const ICON__EDIT: String = "\uf044"    #  | pen-to-square
const ICON__MINUS: String = "\uf068"   #  | minus
const ICON__PLAY: String = "\uf04b"    #  | play
const ICON__PLUS: String = "\u002b"    # + | plus
const ICON__SAVE: String = "\uf0c7"    #  | save
const ICON__STOP: String = "\uf04d"    #  | stop
